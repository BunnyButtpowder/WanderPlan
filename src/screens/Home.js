        ...
        <div>
            ...
            <div className="home">
                ...
                <div className="circle-button">
                    <button id="circle-button-white" onClick={prevPost}>
                        <img src="/img/arrowleft.png" alt="arrow" />
                    </button>
                </div>
                <div className="circle-button" style={{ marginLeft: '12px' }}>
                    <button id="circle-button-black" onClick={nextPost}>
            ...
            <div id="home-comment">
                <div className="left-side left-side-comment">
                    <div className="circle-button">
                        <button id="circle-button-white">
                            <img src="/img/arrowup.png" alt="arrow up" />
                        </button>
                    </div>
                    <div className="circle-button" style={{ marginLeft: '12px' }}>
                        <button id="circle-button-black">
